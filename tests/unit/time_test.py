...
class TestTime:
    ...
    @pytest.mark.parametrize(
        "time, hours, expected_time, expected_days",
        [
    ...
    @pytest.mark.parametrize(
        "time, minutes, expected_time, expected_days",
        [
    ...
    @pytest.mark.parametrize(
        "time, seconds, expected_time, expected_days",
        [
