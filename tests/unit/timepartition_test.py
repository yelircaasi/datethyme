...
class TestTimePartition:
    ...
    def ALT_test_shift_start_rigid(self, original, new_end, transformed):
    ...
    @pytest.mark.parametrize(
        (
            "original, earliest, latest, gap_resolver, "
            "overlap_resolver, min_minutes, squeezed, rollover"
        ),
        [
            (
                REPLACE_ME,
    ...
    def test_index_from_name(self): ...

    def test_index_from_time(self): ...
