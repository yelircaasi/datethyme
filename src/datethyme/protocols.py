...
class SpanProtocol[T: TimeProtocol](DurationProtocol, Protocol):
    ...
    def __bool__(self) -> bool: ...
    def with_start(self, new_start: T) -> SpanProtocol[T]: ...
    def with_end(self, new_end: T) -> SpanProtocol[T]: ...
...
@runtime_checkable
class TimeBlockProtocol[T: TimeProtocol](DurationProtocol, Protocol):
